...
class Jugador{
    ...
    */
    ...
    public static function getEquipos(){
        ...
        $result = $db->query("SELECT equipo.nombreEquipo, CONCAT(usuario.Nombre,' ',usuario.Apellidos) as nombreCapitan,equipo.DescripcionUniforme,usuario.Telefono as TelCapitan from equipo,capitan,usuario,jugador,equipo_jugador WHERE jugador.IDJugador = equipo_jugador.IDJugador AND equipo.IDEquipo = equipo_jugador.IDEquipo AND usuario.Correo = capitan.Correo AND equipo.Correo = capitan.Correo AND jugador.Correo = '".$_SESSION['email']."'");
