                        ...
                        <div class="modal" id="modal-<?php echo $equipo1." VS ".$equipo2.$partido["IDTorneo"].$partido["IDFase"].$partido["juego"] ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body" style="text-align:center;">
                                    <label for="equipo1res">Goles de <?php echo $equipo1 ?>:</label><input type="number" min="0" name="equipo1res" id="equipo1res" value="0"><br><br>
                                    <label for="equipo2res">Goles de <?php echo $equipo2 ?>:</label><input type="number" min="0" name="equipo2res" name="equipo2res" value="0">
                                </div>
